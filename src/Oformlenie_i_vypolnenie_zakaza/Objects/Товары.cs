...
namespace IIS.Oformlenie_i_vypolnenie_zakaza
{
    ...
    public class Товары : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Oformlenie_i_vypolnenie_zakaza.ВНаличии fВНаличии;
        ...
        [PropertyStorage(new string[] {
                "ВНаличии"})]
        [NotNull()]
        public virtual IIS.Oformlenie_i_vypolnenie_zakaza.ВНаличии ВНаличии
        {
            get
            {
                ...
                IIS.Oformlenie_i_vypolnenie_zakaza.ВНаличии result = this.fВНаличии;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТоварыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварыE", typeof(IIS.Oformlenie_i_vypolnenie_zakaza.Товары));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ТоварыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварыL", typeof(IIS.Oformlenie_i_vypolnenie_zakaza.Товары));
                }
            }
        }
    }
