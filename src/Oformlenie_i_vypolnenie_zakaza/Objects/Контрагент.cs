    ...
    public class Контрагент : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КонтрагентE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КонтрагентE", typeof(IIS.Oformlenie_i_vypolnenie_zakaza.Контрагент));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КонтрагентL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КонтрагентL", typeof(IIS.Oformlenie_i_vypolnenie_zakaza.Контрагент));
                }
            }
        }
    }
