...
moduleForAcceptance('[AGAT] Acceptance | i i s oformlenie i vypolnenie zakaza место выдачи l');

test('testing i-i-s-oformlenie-i-vypolnenie-zakaza-место-выдачи-l', function(assert) {
