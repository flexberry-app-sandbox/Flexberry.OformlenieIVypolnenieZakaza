...
moduleForAcceptance('[AGAT] Acceptance | i i s oformlenie i vypolnenie zakaza контрагент l');

test('testing i-i-s-oformlenie-i-vypolnenie-zakaza-контрагент-l', function(assert) {
