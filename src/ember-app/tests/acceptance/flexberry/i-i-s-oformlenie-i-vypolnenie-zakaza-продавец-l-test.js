...
moduleForAcceptance('[AGAT] Acceptance | i i s oformlenie i vypolnenie zakaza продавец l');

test('testing i-i-s-oformlenie-i-vypolnenie-zakaza-продавец-l', function(assert) {
