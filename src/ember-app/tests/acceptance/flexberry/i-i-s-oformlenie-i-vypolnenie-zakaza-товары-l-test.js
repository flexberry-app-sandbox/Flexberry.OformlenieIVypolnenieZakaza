...
moduleForAcceptance('[AGAT] Acceptance | i i s oformlenie i vypolnenie zakaza товары l');

test('testing i-i-s-oformlenie-i-vypolnenie-zakaza-товары-l', function(assert) {
