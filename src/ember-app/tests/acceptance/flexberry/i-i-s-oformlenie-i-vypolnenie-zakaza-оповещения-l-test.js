...
moduleForAcceptance('[AGAT] Acceptance | i i s oformlenie i vypolnenie zakaza оповещения l');

test('testing i-i-s-oformlenie-i-vypolnenie-zakaza-оповещения-l', function(assert) {
