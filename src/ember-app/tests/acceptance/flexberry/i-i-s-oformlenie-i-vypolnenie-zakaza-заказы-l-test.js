...
moduleForAcceptance('[AGAT] Acceptance | i i s oformlenie i vypolnenie zakaza заказы l');

test('testing i-i-s-oformlenie-i-vypolnenie-zakaza-заказы-l', function(assert) {
