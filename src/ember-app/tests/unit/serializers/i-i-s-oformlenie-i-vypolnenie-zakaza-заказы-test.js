...
moduleForModel('i-i-s-oformlenie-i-vypolnenie-zakaza-заказы', 'Unit | Serializer | i-i-s-oformlenie-i-vypolnenie-zakaza-заказы', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-oformlenie-i-vypolnenie-zakaza-заказы',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
