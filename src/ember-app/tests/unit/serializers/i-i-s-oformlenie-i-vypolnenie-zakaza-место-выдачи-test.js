...
moduleForModel('i-i-s-oformlenie-i-vypolnenie-zakaza-место-выдачи', 'Unit | Serializer | i-i-s-oformlenie-i-vypolnenie-zakaza-место-выдачи', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-oformlenie-i-vypolnenie-zakaza-место-выдачи',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
