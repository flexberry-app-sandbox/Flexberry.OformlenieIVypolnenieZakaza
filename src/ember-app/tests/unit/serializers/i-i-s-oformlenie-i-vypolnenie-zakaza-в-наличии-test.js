...
moduleForModel('i-i-s-oformlenie-i-vypolnenie-zakaza-в-наличии', 'Unit | Serializer | i-i-s-oformlenie-i-vypolnenie-zakaza-в-наличии', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-oformlenie-i-vypolnenie-zakaza-в-наличии',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
