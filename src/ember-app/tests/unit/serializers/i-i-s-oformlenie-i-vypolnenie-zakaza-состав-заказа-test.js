...
moduleForModel('i-i-s-oformlenie-i-vypolnenie-zakaza-состав-заказа', 'Unit | Serializer | i-i-s-oformlenie-i-vypolnenie-zakaza-состав-заказа', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-oformlenie-i-vypolnenie-zakaza-состав-заказа',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
