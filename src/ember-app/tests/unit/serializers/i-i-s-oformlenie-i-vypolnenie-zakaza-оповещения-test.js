...
moduleForModel('i-i-s-oformlenie-i-vypolnenie-zakaza-оповещения', 'Unit | Serializer | i-i-s-oformlenie-i-vypolnenie-zakaza-оповещения', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-oformlenie-i-vypolnenie-zakaza-оповещения',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
