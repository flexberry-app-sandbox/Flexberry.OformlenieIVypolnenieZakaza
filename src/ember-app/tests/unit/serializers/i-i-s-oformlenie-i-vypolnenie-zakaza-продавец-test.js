...
moduleForModel('i-i-s-oformlenie-i-vypolnenie-zakaza-продавец', 'Unit | Serializer | i-i-s-oformlenie-i-vypolnenie-zakaza-продавец', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-oformlenie-i-vypolnenie-zakaza-продавец',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
