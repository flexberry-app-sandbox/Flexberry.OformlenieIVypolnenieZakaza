...
moduleForModel('i-i-s-oformlenie-i-vypolnenie-zakaza-товары', 'Unit | Serializer | i-i-s-oformlenie-i-vypolnenie-zakaza-товары', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-oformlenie-i-vypolnenie-zakaza-товары',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
